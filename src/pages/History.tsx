      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold text-gradient mb-2">Your History</h1>
          ...
          {attempts.length === 0 ? (
            ...
            <div className="space-y-4">
              {sortedAttempts.map((attempt) => (
                <div
                  key={attempt.id}
                  className="rounded-xl border border-border bg-gradient-card p-6 hover:shadow-lg transition-shadow cursor-pointer"
                  onClick={() => navigate(`/results/${attempt.id}`)}
                >
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      <h3 className="text-lg font-semibold mb-1">{attempt.song_name}</h3>
                    ...
                    <div className="flex items-center gap-6">
                      <div className="text-right">
                        ...
                        <p className={`text-3xl font-bold ${getScoreColor(attempt.overall_score)}`}>
